...
class ActionRegistry:
    ...
    def __init__(self) -> None:
        ...
        definitions = [
            ...
            ActionDefinition(action_id=ActionId.RUN_SFC_SCAN, name="Run System File Checker", description="Run predefined SFC scan through the controlled executor.", risk_level=RiskLevel.MEDIUM, requires_approval=True, parameter_schema={"type": "object", "properties": {}, "additionalProperties": False}, executor_name="run_sfc_scan", verifier_name="verify_sfc_result", enabled=True),
